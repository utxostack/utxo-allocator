...
__export(src_exports, {
  ...
  BTCTimeUnlock: () => BTCTimeUnlock,
  BTC_JUMP_CONFIRMATION_BLOCKS: () => BTC_JUMP_CONFIRMATION_BLOCKS,
  Block: () => Block,
  BlockV1: () => BlockV1,
  Byte32: () => Byte32,
  Byte32Vec: () => Byte32Vec,
  Bytes: () => Bytes,
  BytesOpt: () => BytesOpt,
  BytesOptVec: () => BytesOptVec,
  BytesVec: () => BytesVec,
  CKB_UNIT: () => CKB_UNIT,
  CapacityNotEnoughError: () => CapacityNotEnoughError,
  CellDep: () => CellDep,
  CellDepVec: () => CellDepVec,
  CellInput: () => CellInput,
  CellInputVec: () => CellInputVec,
  CellOutput: () => CellOutput,
  CellOutputVec: () => CellOutputVec,
  CellbaseWitness: () => CellbaseWitness,
  Collector: () => Collector,
  ExtraCommitmentData: () => ExtraCommitmentData,
  Header: () => Header,
  IndexerError: () => IndexerError,
  InputsCapacityNotEnoughError: () => InputsCapacityNotEnoughError,
  InputsOrOutputsLenError: () => InputsOrOutputsLenError,
  InvalidCellIdError: () => InvalidCellIdError,
  MAX_FEE: () => MAX_FEE,
  MIN_CAPACITY: () => MIN_CAPACITY,
  NoLiveCellError: () => NoLiveCellError,
  NoRgbppLiveCellError: () => NoRgbppLiveCellError,
  NoXudtLiveCellError: () => NoXudtLiveCellError,
  OutPoint: () => OutPoint,
  ProposalShortId: () => ProposalShortId,
  ProposalShortIdVec: () => ProposalShortIdVec,
  RGBPPConfig: () => RGBPPConfig,
  RGBPPLock: () => RGBPPLock,
  RGBPPUnlock: () => RGBPPUnlock,
  RGBPP_TX_ID_PLACEHOLDER: () => RGBPP_TX_ID_PLACEHOLDER,
  RGBPP_TX_INPUTS_MAX_LENGTH: () => RGBPP_TX_INPUTS_MAX_LENGTH,
  RGBPP_TX_WITNESS_MAX_SIZE: () => RGBPP_TX_WITNESS_MAX_SIZE,
  RGBPP_WITNESS_PLACEHOLDER: () => RGBPP_WITNESS_PLACEHOLDER,
  RawHeader: () => RawHeader,
  RawTransaction: () => RawTransaction,
  RgbppCkbTxInputsExceededError: () => RgbppCkbTxInputsExceededError,
  RgbppSporeTypeMismatchError: () => RgbppSporeTypeMismatchError,
  RgbppUtxoBindMultiTypeAssetsError: () => RgbppUtxoBindMultiTypeAssetsError,
  SECP256K1_WITNESS_LOCK_SIZE: () => SECP256K1_WITNESS_LOCK_SIZE,
  Script: () => Script,
  ScriptOpt: () => ScriptOpt,
  Transaction: () => Transaction,
  TransactionVec: () => TransactionVec,
  TypeAssetNotSupportedError: () => TypeAssetNotSupportedError,
  UNLOCKABLE_LOCK_SCRIPT: () => UNLOCKABLE_LOCK_SCRIPT,
  UdtAmountNotEnoughError: () => UdtAmountNotEnoughError,
  Uint16: () => Uint16,
  Uint256: () => Uint256,
  UncleBlock: () => UncleBlock,
  UncleBlockVec: () => UncleBlockVec,
  WitnessArgs: () => WitnessArgs,
  append0x: () => append0x,
  appendCkbTxWitnesses: () => appendCkbTxWitnesses,
  appendIssuerCellToBtcBatchTransfer: () => appendIssuerCellToBtcBatchTransfer,
  appendIssuerCellToSporesCreate: () => appendIssuerCellToSporesCreate,
  appendPaymasterCellAndSignCkbTx: () => appendPaymasterCellAndSignCkbTx,
  btcTxIdAndAfterFromBtcTimeLockArgs: () => btcTxIdAndAfterFromBtcTimeLockArgs,
  buildAppendingIssuerCellToSporesCreateTx: () => buildAppendingIssuerCellToSporesCreateTx,
  buildBtcTimeCellsSpentTx: () => buildBtcTimeCellsSpentTx,
  buildBtcTimeUnlockWitness: () => buildBtcTimeUnlockWitness,
  buildPreLockArgs: () => buildPreLockArgs,
  buildRgbppLockArgs: () => buildRgbppLockArgs,
  buildRgbppUnlockWitness: () => buildRgbppUnlockWitness,
  buildSporeBtcTimeCellsSpentTx: () => buildSporeBtcTimeCellsSpentTx,
  buildSpvClientCellDep: () => buildSpvClientCellDep,
  calculateCellOccupiedCapacity: () => calculateCellOccupiedCapacity,
  calculateCommitment: () => calculateCommitment,
  calculateRgbppCellCapacity: () => calculateRgbppCellCapacity,
  calculateRgbppClusterCellCapacity: () => calculateRgbppClusterCellCapacity,
  calculateRgbppSporeCellCapacity: () => calculateRgbppSporeCellCapacity,
  calculateRgbppTokenInfoCellCapacity: () => calculateRgbppTokenInfoCellCapacity,
  calculateRgbppTokenInfoSize: () => calculateRgbppTokenInfoSize,
  calculateTransactionFee: () => calculateTransactionFee,
  calculateUdtCellCapacity: () => calculateUdtCellCapacity,
  calculateXudtTokenInfoCellCapacity: () => calculateXudtTokenInfoCellCapacity,
  checkCkbTxInputsCapacitySufficient: () => checkCkbTxInputsCapacitySufficient,
  compareInputs: () => compareInputs,
  decodeCellId: () => decodeCellId,
  deduplicateList: () => deduplicateList,
  encodeCellId: () => encodeCellId,
  encodeRgbppTokenInfo: () => encodeRgbppTokenInfo,
  estimateWitnessSize: () => estimateWitnessSize,
  fetchTypeIdCellDeps: () => fetchTypeIdCellDeps,
  genBtcBatchTransferCkbVirtualTx: () => genBtcBatchTransferCkbVirtualTx,
  genBtcJumpCkbVirtualTx: () => genBtcJumpCkbVirtualTx,
  genBtcTimeLockArgs: () => genBtcTimeLockArgs,
  genBtcTimeLockScript: () => genBtcTimeLockScript,
  genBtcTransferCkbVirtualTx: () => genBtcTransferCkbVirtualTx,
  genCkbBatchJumpBtcVirtualTx: () => genCkbBatchJumpBtcVirtualTx,
  genCkbJumpBtcVirtualTx: () => genCkbJumpBtcVirtualTx,
  genCreateClusterCkbVirtualTx: () => genCreateClusterCkbVirtualTx,
  genCreateSporeCkbVirtualTx: () => genCreateSporeCkbVirtualTx,
  genLeapSporeFromBtcToCkbVirtualTx: () => genLeapSporeFromBtcToCkbVirtualTx,
  genLeapSporeFromCkbToBtcRawTx: () => genLeapSporeFromCkbToBtcRawTx,
  genRgbppLaunchCkbVirtualTx: () => genRgbppLaunchCkbVirtualTx,
  genRgbppLockScript: () => genRgbppLockScript,
  genTransferSporeCkbVirtualTx: () => genTransferSporeCkbVirtualTx,
  generateClusterCreateCoBuild: () => generateClusterCreateCoBuild,
  generateClusterId: () => generateClusterId,
  generateSporeCreateCoBuild: () => generateSporeCreateCoBuild,
  generateSporeId: () => generateSporeId,
  generateSporeTransferCoBuild: () => generateSporeTransferCoBuild,
  generateUniqueTypeArgs: () => generateUniqueTypeArgs,
  getBtcTimeLockConfigDep: () => getBtcTimeLockConfigDep,
  getBtcTimeLockDep: () => getBtcTimeLockDep,
  getBtcTimeLockScript: () => getBtcTimeLockScript,
  getClusterTypeDep: () => getClusterTypeDep,
  getClusterTypeScript: () => getClusterTypeScript,
  getRgbppLockConfigDep: () => getRgbppLockConfigDep,
  getRgbppLockDep: () => getRgbppLockDep,
  getRgbppLockScript: () => getRgbppLockScript,
  getSecp256k1CellDep: () => getSecp256k1CellDep,
  getSporeTypeDep: () => getSporeTypeDep,
  getSporeTypeScript: () => getSporeTypeScript,
  getUniqueTypeDep: () => getUniqueTypeDep,
  getUniqueTypeScript: () => getUniqueTypeScript,
  getXudtDep: () => getXudtDep,
  getXudtTypeScript: () => getXudtTypeScript,
  hexToUtf8: () => hexToUtf8,
  isBtcTimeCellsSpent: () => isBtcTimeCellsSpent,
  isBtcTimeLockCell: () => isBtcTimeLockCell,
  isClusterSporeTypeSupported: () => isClusterSporeTypeSupported,
  isLockArgsSizeExceeded: () => isLockArgsSizeExceeded,
  isRgbppCapacitySufficientForChange: () => isRgbppCapacitySufficientForChange,
  isRgbppLockCell: () => isRgbppLockCell,
  isRgbppLockCellIgnoreChain: () => isRgbppLockCellIgnoreChain,
  isRgbppLockOrBtcTimeLock: () => isRgbppLockOrBtcTimeLock,
  isScriptEqual: () => isScriptEqual,
  isSporeTypeSupported: () => isSporeTypeSupported,
  isTypeAssetSupported: () => isTypeAssetSupported,
  isUDTTypeSupported: () => isUDTTypeSupported,
  leToU128: () => leToU128,
  leToU32: () => leToU32,
  lockScriptFromBtcTimeLockArgs: () => lockScriptFromBtcTimeLockArgs,
  remove0x: () => remove0x,
  replaceLockArgsWithRealBtcTxId: () => replaceLockArgsWithRealBtcTxId,
  reverseHex: () => reverseHex,
  sendCkbTx: () => sendCkbTx,
  serializeScript: () => import_ckb_sdk_utils3.serializeScript,
  signBtcTimeCellSpentTx: () => signBtcTimeCellSpentTx,
  splitMultiCellsWithSecp256k1: () => splitMultiCellsWithSecp256k1,
  throwErrorWhenRgbppCellsInvalid: () => throwErrorWhenRgbppCellsInvalid,
  throwErrorWhenSporeCellsInvalid: () => throwErrorWhenSporeCellsInvalid,
  throwErrorWhenTxInputsExceeded: () => throwErrorWhenTxInputsExceeded,
  toCamelcase: () => toCamelcase,
  transformSpvProof: () => transformSpvProof,
  u128ToLe: () => u128ToLe,
  u16ToLe: () => u16ToLe,
  u32ToBe: () => u32ToBe,
  u32ToLe: () => u32ToLe,
  u32ToLeHex: () => u32ToLeHex,
  u64ToLe: () => u64ToLe,
  u8ToHex: () => u8ToHex,
  unpackRgbppLockArgs: () => unpackRgbppLockArgs,
  updateCkbTxWithRealBtcTxId: () => updateCkbTxWithRealBtcTxId,
  utf8ToHex: () => utf8ToHex
});
module.exports = __toCommonJS(src_exports);

// src/schemas/generated/blockchain.ts
var import_codec2 = require("@ckb-lumos/codec");

// src/schemas/customized.ts
var import_codec = require("@ckb-lumos/codec");
var { Uint32, Uint64, Uint128 } = import_codec.number;
var HashType = (0, import_codec.createFixedBytesCodec)({
  byteLength: 1,
  // prettier-ignore
  pack: (hashType) => {
...
var DepType = (0, import_codec.createFixedBytesCodec)({
  byteLength: 1,
  // prettier-ignore
  pack: (depType) => {
...
// src/schemas/generated/blockchain.ts
var { array, vector, union, option, struct, table, byteVecOf } = import_codec2.molecule;
var fallbackBytesCodec = byteVecOf({ pack: import_codec2.bytes.bytify, unpack: import_codec2.bytes.hexify });
function createFallbackFixedBytesCodec(byteLength) {
  return (0, import_codec2.createFixedBytesCodec)({
    pack: import_codec2.bytes.bytify,
    unpack: import_codec2.bytes.hexify,
    byteLength
  });
}
...
var import_codec3 = require("@ckb-lumos/codec");
var { array: array2, vector: vector2, union: union2, option: option2, struct: struct2, table: table2, byteVecOf: byteVecOf2 } = import_codec3.molecule;
var fallbackBytesCodec2 = byteVecOf2({ pack: import_codec3.bytes.bytify, unpack: import_codec3.bytes.hexify });
function createFallbackFixedBytesCodec2(byteLength) {
  return (0, import_codec3.createFixedBytesCodec)({
    pack: import_codec3.bytes.bytify,
    unpack: import_codec3.bytes.hexify,
    byteLength
  });
}
...
var import_ckb_sdk_core = __toESM(require("@nervosnetwork/ckb-sdk-core"));
...
var toCamelcase = (obj) => {
  try {
    return (0, import_camelcase_keys.default)(obj, {
      deep: true
    });
  } catch (error) {
    console.error(error);
...
// src/utils/hex.ts
var import_ckb_sdk_utils = require("@nervosnetwork/ckb-sdk-utils");
var remove0x = (hex) => {
...
var leToU32 = (leHex) => {
  const bytes3 = (0, import_ckb_sdk_utils.hexToBytes)(append0x(leHex));
...
var utf8ToHex = (text) => {
  ...
  result = (0, import_ckb_sdk_utils.bytesToHex)(new TextEncoder().encode(result));
  return result;
};
var hexToUtf8 = (hex) => {
  let result = hex.trim();
  try {
    result = new TextDecoder().decode((0, import_ckb_sdk_utils.hexToBytes)(result));
  } catch (error) {
...
var reverseHex = (str) => {
  return (0, import_ckb_sdk_utils.bytesToHex)((0, import_ckb_sdk_utils.hexToBytes)(append0x(str)).reverse());
};

// src/utils/ckb-tx.ts
var import_ckb_sdk_utils3 = require("@nervosnetwork/ckb-sdk-utils");
var import_core = require("@spore-sdk/core");

// src/utils/rgbpp.ts
var import_js_sha256 = require("js-sha256");
var import_base = require("@ckb-lumos/base");
var import_ckb_sdk_utils2 = require("@nervosnetwork/ckb-sdk-utils");
...
var genBtcTimeLockArgs = (lock, btcTxId, after) => {
  const btcTxid = import_base.blockchain.Byte32.pack(reverseHex(btcTxId));
  const lockScript = Script.unpack((0, import_ckb_sdk_utils2.serializeScript)(lock));
  return (0, import_ckb_sdk_utils2.bytesToHex)(BTCTimeLock.pack({ lockScript, after, btcTxid }));
};
...
var calculateCommitment = (rgbppVirtualTx) => {
  ...
  hash.update((0, import_ckb_sdk_utils2.hexToBytes)(utf8ToHex("RGB++")));
  const version = [0, 0];
  hash.update(version);
  ...
  for (const input of inputs) {
    hash.update((0, import_ckb_sdk_utils2.hexToBytes)((0, import_ckb_sdk_utils2.serializeOutPoint)(input.previousOutput)));
  }
  for (let index = 0; index < outputs.length; index++) {
    const output = outputs[index];
    const outputData = outputsData[index];
    hash.update((0, import_ckb_sdk_utils2.hexToBytes)((0, import_ckb_sdk_utils2.serializeOutput)(output)));
    const outputDataLen = u32ToLe(remove0x(outputData).length / 2);
    hash.update((0, import_ckb_sdk_utils2.hexToBytes)(append0x(outputDataLen)));
    hash.update((0, import_ckb_sdk_utils2.hexToBytes)(outputData));
  }
  return (0, import_js_sha256.sha256)(hash.array());
};
...
var isUDTTypeSupported = (type, isMainnet) => {
  const xudtType = (0, import_ckb_sdk_utils3.serializeScript)(getXudtTypeScript(isMainnet));
  const typeAsset = (0, import_ckb_sdk_utils3.serializeScript)({
    ...type,
    args: ""
  });
...
var isSporeTypeSupported = (type, isMainnet) => {
  const sporeType = (0, import_ckb_sdk_utils3.serializeScript)(getSporeTypeScript(isMainnet));
  const typeAsset = (0, import_ckb_sdk_utils3.serializeScript)({
    ...type,
    args: ""
  });
...
var isClusterSporeTypeSupported = (type, isMainnet) => {
  ...
  const clusterType = (0, import_ckb_sdk_utils3.serializeScript)(getClusterTypeScript(isMainnet));
...
var generateUniqueTypeArgs = (firstInput, firstOutputIndex) => {
  const input = (0, import_ckb_sdk_utils3.hexToBytes)((0, import_ckb_sdk_utils3.serializeInput)(firstInput));
  const s = (0, import_ckb_sdk_utils3.blake2b)(32, null, null, import_ckb_sdk_utils3.PERSONAL);
  s.update(input);
  s.update((0, import_ckb_sdk_utils3.hexToBytes)(`0x${u64ToLe(BigInt(firstOutputIndex))}`));
  return `0x${s.digest("hex").slice(0, 40)}`;
};
var calculateRgbppClusterCellCapacity = (clusterData) => {
  const clusterDataSize = (0, import_core.packRawClusterData)(clusterData).length;
...
var calculateRgbppSporeCellCapacity = (sporeData) => {
  const sporeDataSize = (0, import_core.packRawSporeData)(sporeData).length;
...
var isScriptEqual = (s1, s2) => {
  const temp1 = typeof s1 === "string" ? remove0x(s1) : remove0x((0, import_ckb_sdk_utils3.serializeScript)(s1));
  const temp2 = typeof s2 === "string" ? remove0x(s2) : remove0x((0, import_ckb_sdk_utils3.serializeScript)(s2));
  return temp1 === temp2;
};
...
// src/utils/spore.ts
var import_cobuild = require("@spore-sdk/core/lib/cobuild/index.js");
var import_ckb_sdk_utils4 = require("@nervosnetwork/ckb-sdk-utils");
var generateClusterId = (firstInput, firstOutputIndex) => {
  const input = (0, import_ckb_sdk_utils4.hexToBytes)((0, import_ckb_sdk_utils4.serializeInput)(firstInput));
  const s = (0, import_ckb_sdk_utils4.blake2b)(32, null, null, import_ckb_sdk_utils4.PERSONAL);
  s.update(input);
  s.update((0, import_ckb_sdk_utils4.hexToBytes)(`0x${u64ToLe(BigInt(firstOutputIndex))}`));
...
var generateClusterCreateCoBuild = (clusterOutput, clusterOutputData) => {
  ...
  const { actions } = (0, import_cobuild.assembleCreateClusterAction)(output);
  return (0, import_cobuild.assembleCobuildWitnessLayout)(actions);
};
var generateSporeCreateCoBuild = ({
  ...
  const { actions } = (0, import_cobuild.assembleTransferClusterAction)(clusterInput, clusterOutput);
  ...
  for (let index = 0; index < sporeOutputs.length; index++) {
    ...
    const { actions: actions2 } = (0, import_cobuild.assembleCreateSporeAction)(sporeOutput);
    sporeActions = sporeActions.concat(actions2);
  }
  return (0, import_cobuild.assembleCobuildWitnessLayout)(sporeActions);
};
var generateSporeTransferCoBuild = (sporeCells, outputCells) => {
  ...
  for (let index = 0; index < sporeCells.length; index++) {
    ...
    const { actions } = (0, import_cobuild.assembleTransferSporeAction)(sporeInput, sporeOutput);
    sporeActions = sporeActions.concat(actions);
  }
  return (0, import_cobuild.assembleCobuildWitnessLayout)(sporeActions);
};
...
var request = (url) => import_axios.default.get(url, { timeout: 2e3 });
...
// src/utils/id.ts
var import_base2 = require("@ckb-lumos/base");
var encodeCellId = (txHash, index) => {
  ...
  try {
    import_base2.blockchain.OutPoint.pack({
      txHash,
      index
    });
    return `${txHash}:${index}`;
...
var Collector = class {
  ...
  getCkb() {
    return new import_ckb_sdk_core.default(this.ckbNodeUrl);
  }
  async getCells({
    lock,
    type,
  ...
  async getLiveCell(outPoint, withData = true) {
    const ckb = new import_ckb_sdk_core.default(this.ckbNodeUrl);
...
var import_ckb_sdk_utils5 = require("@nervosnetwork/ckb-sdk-utils");
...
var splitMultiCellsWithSecp256k1 = async ({
  ...
  const masterAddress = (0, import_ckb_sdk_utils5.privateKeyToAddress)(masterPrivateKey, {
    prefix: isMainnet ? import_ckb_sdk_utils5.AddressPrefix.Mainnet : import_ckb_sdk_utils5.AddressPrefix.Testnet
  });
  const masterLock = (0, import_ckb_sdk_utils5.addressToScript)(masterAddress);
  ...
  const outputs = new Array(cellAmount).fill({
    lock: (0, import_ckb_sdk_utils5.addressToScript)(receiverAddress),
  ...
  if (txFee === MAX_FEE) {
    const txSize = (0, import_ckb_sdk_utils5.getTransactionSize)(unsignedTx) + SECP256K1_WITNESS_LOCK_SIZE;
...
var import_base3 = require("@ckb-lumos/base");
var import_signWitnesses = __toESM(require("@nervosnetwork/ckb-sdk-core/lib/signWitnesses"));
var import_ckb_sdk_utils6 = require("@nervosnetwork/ckb-sdk-utils");
var genBtcTransferCkbVirtualTx = async ({
  ...
  const xudtType = import_base3.blockchain.Script.unpack(xudtTypeBytes);
  ...
  if (!needPaymasterCell) {
    const txSize = (0, import_ckb_sdk_utils6.getTransactionSize)(ckbRawTx) + (witnessLockPlaceholderSize ?? estimateWitnessSize(deduplicatedLockArgsList));
...
var appendIssuerCellToBtcBatchTransfer = async ({
  ...
  const issuerLock = (0, import_ckb_sdk_utils6.addressToScript)(issuerAddress);
  ...
  const txSize = (0, import_ckb_sdk_utils6.getTransactionSize)(rawTx) + SECP256K1_WITNESS_LOCK_SIZE;
  const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
  changeCapacity -= estimatedTxFee;
  rawTx.outputs[rawTx.outputs.length - 1].capacity = append0x(changeCapacity.toString(16));
  const keyMap = /* @__PURE__ */ new Map();
  keyMap.set((0, import_ckb_sdk_utils6.scriptToHash)(issuerLock), secp256k1PrivateKey);
  ...
  const transactionHash = (0, import_ckb_sdk_utils6.rawTransactionToHash)(rawTx);
  const signedWitnesses = (0, import_signWitnesses.default)(keyMap)({
    transactionHash,
  ...
  const signedTx = {
    ...
    witnesses: signedWitnesses.map(
      (witness) => typeof witness !== "string" ? (0, import_ckb_sdk_utils6.serializeWitnessArgs)(witness) : witness
    )
  };
  return signedTx;
};
...
var import_signWitnesses2 = __toESM(require("@nervosnetwork/ckb-sdk-core/lib/signWitnesses"));
var import_ckb_sdk_utils7 = require("@nervosnetwork/ckb-sdk-utils");
var buildRgbppUnlockWitness = (btcTxBytes, btcTxProof, inputsLen, outputsLen) => {
  ...
  return append0x((0, import_ckb_sdk_utils7.bytesToHex)(rgbppUnlock));
};
var appendCkbTxWitnesses = async ({
  ...
  const rgbppWitness = append0x((0, import_ckb_sdk_utils7.serializeWitnessArgs)({ lock: rgbppUnlock, inputType: "", outputType: "" }));
...
var appendPaymasterCellAndSignCkbTx = async ({
  ...
  rawTx.outputs = [...rawTx.outputs, changeOutput];
  rawTx.outputsData = [...rawTx.outputsData, "0x"];
  const txSize = (0, import_ckb_sdk_utils7.getTransactionSize)(rawTx) + SECP256K1_WITNESS_LOCK_SIZE;
  const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
  changeCapacity -= estimatedTxFee;
  rawTx.outputs[rawTx.outputs.length - 1].capacity = append0x(changeCapacity.toString(16));
  const keyMap = /* @__PURE__ */ new Map();
  keyMap.set((0, import_ckb_sdk_utils7.scriptToHash)(paymasterCell.output.lock), secp256k1PrivateKey);
  keyMap.set((0, import_ckb_sdk_utils7.scriptToHash)(getRgbppLockScript(isMainnet)), "");
  ...
  const transactionHash = (0, import_ckb_sdk_utils7.rawTransactionToHash)(rawTx);
  const signedWitnesses = (0, import_signWitnesses2.default)(keyMap)({
    transactionHash,
    witnesses: rawTx.witnesses,
    inputCells: cells,
    skipMissingKeys: true
  ...
  const signedTx = {
    ...rawTx,
    witnesses: signedWitnesses.map(
      (witness) => typeof witness !== "string" ? (0, import_ckb_sdk_utils7.serializeWitnessArgs)(witness) : witness
    )
  };
  return signedTx;
};
...
var import_base4 = require("@ckb-lumos/base");
var import_ckb_sdk_utils8 = require("@nervosnetwork/ckb-sdk-utils");
var genBtcJumpCkbVirtualTx = async ({
  ...
  const xudtType = import_base4.blockchain.Script.unpack(xudtTypeBytes);
  if (!isUDTTypeSupported(xudtType, isMainnet)) {
    throw new TypeAssetNotSupportedError("The type script asset is not supported now");
  }
  const deduplicatedLockArgsList = deduplicateList(rgbppLockArgsList);
  ...
  throwErrorWhenTxInputsExceeded(inputs.length);
  const rgbppCellCapacity = calculateRgbppCellCapacity(xudtType);
  const toLock = (0, import_ckb_sdk_utils8.addressToScript)(toCkbAddress);
  ...
  if (!needPaymasterCell) {
    const txSize = (0, import_ckb_sdk_utils8.getTransactionSize)(ckbRawTx) + (witnessLockPlaceholderSize ?? estimateWitnessSize(deduplicatedLockArgsList));
    const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
    const changeCapacity = BigInt(outputs[outputs.length - 1].capacity) - estimatedTxFee;
    ckbRawTx.outputs[ckbRawTx.outputs.length - 1].capacity = append0x(changeCapacity.toString(16));
  }
...
var import_ckb_sdk_utils9 = require("@nervosnetwork/ckb-sdk-utils");
var import_signWitnesses3 = __toESM(require("@nervosnetwork/ckb-sdk-core/lib/signWitnesses"));
var buildBtcTimeUnlockWitness = (btcTxProof) => {
  const btcTimeUnlock = BTCTimeUnlock.pack({ btcTxProof });
  return append0x((0, import_ckb_sdk_utils9.bytesToHex)(btcTimeUnlock));
};
var buildBtcTimeCellsSpentTx = async ({
  ...
  for await (const btcTimeCell of sortedBtcTimeCells) {
    ...
    if (!cellDepsSet.has((0, import_ckb_sdk_utils9.serializeOutPoint)(spvClient))) {
      cellDeps.push(buildSpvClientCellDep(spvClient));
      cellDepsSet.add((0, import_ckb_sdk_utils9.serializeOutPoint)(spvClient));
    }
    const btcTimeWitness = append0x(
      (0, import_ckb_sdk_utils9.serializeWitnessArgs)({ lock: buildBtcTimeUnlockWitness(proof), inputType: "", outputType: "" })
    );
...
var signBtcTimeCellSpentTx = async ({
  ...
  const masterLock = (0, import_ckb_sdk_utils9.addressToScript)(masterCkbAddress);
  let emptyCells = await collector.getCells({
    lock: masterLock,
    outputCapacityRange
  });
  ...
  const txSize = (0, import_ckb_sdk_utils9.getTransactionSize)(rawTx) + SECP256K1_WITNESS_LOCK_SIZE;
  const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
  ...
  const keyMap = /* @__PURE__ */ new Map();
  keyMap.set((0, import_ckb_sdk_utils9.scriptToHash)(masterLock), secp256k1PrivateKey);
  const cells = rawTx.inputs.map((input, index) => ({
    outPoint: input.previousOutput,
    lock: index === 0 ? masterLock : getBtcTimeLockScript(isMainnet)
  }));
  const transactionHash = (0, import_ckb_sdk_utils9.rawTransactionToHash)(rawTx);
  const signedWitnesses = (0, import_signWitnesses3.default)(keyMap)({
    transactionHash,
    witnesses: rawTx.witnesses,
    inputCells: cells,
    skipMissingKeys: true
  ...
  const signedTx = {
    ...rawTx,
    witnesses: signedWitnesses.map(
      (witness) => typeof witness !== "string" ? (0, import_ckb_sdk_utils9.serializeWitnessArgs)(witness) : witness
    )
  };
  return signedTx;
};
var isBtcTimeCellsSpent = async ({
  ...
  const lock = (0, import_ckb_sdk_utils9.addressToScript)(ckbAddress);
  const btcTimeLock = {
    ...getBtcTimeLockScript(isMainnet, btcTestnetType),
...
var import_base5 = require("@ckb-lumos/base");
var import_ckb_sdk_utils10 = require("@nervosnetwork/ckb-sdk-utils");
var genCkbJumpBtcVirtualTx = async ({
  ...
  const xudtType = import_base5.blockchain.Script.unpack(xudtTypeBytes);
  if (!isTypeAssetSupported(xudtType, isMainnet)) {
    throw new TypeAssetNotSupportedError("The type script asset is not supported now");
  }
  const fromLock = (0, import_ckb_sdk_utils10.addressToScript)(fromCkbAddress);
  ...
  if (txFee === MAX_FEE) {
    const txSize = (0, import_ckb_sdk_utils10.getTransactionSize)(ckbRawTx) + (witnessLockPlaceholderSize ?? RGBPP_TX_WITNESS_MAX_SIZE);
    const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
    const estimatedChangeCapacity = changeCapacity + (MAX_FEE - estimatedTxFee);
...
// src/rgbpp/launch.ts
var import_ckb_sdk_utils11 = require("@nervosnetwork/ckb-sdk-utils");
var genRgbppLaunchCkbVirtualTx = async ({
  ...
  const outputs = [
    {
      ...
      type: {
        ...
        args: append0x((0, import_ckb_sdk_utils11.scriptToHash)(ownerLock))
      },
  ...
  const txSize = (0, import_ckb_sdk_utils11.getTransactionSize)(ckbRawTx) + (witnessLockPlaceholderSize ?? RGBPP_TX_WITNESS_MAX_SIZE);
  const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
...
var import_core2 = require("@spore-sdk/core");
var import_ckb_sdk_utils12 = require("@nervosnetwork/ckb-sdk-utils");
var genCreateClusterCkbVirtualTx = async ({
  ...
  const outputsData = [(0, import_ckb_sdk_utils12.bytesToHex)((0, import_core2.packRawClusterData)(clusterData))];
  const cellDeps = [
  ...
  const txSize = (0, import_ckb_sdk_utils12.getTransactionSize)(ckbRawTx) + (witnessLockPlaceholderSize ?? RGBPP_TX_WITNESS_MAX_SIZE);
  const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
  changeCapacity -= estimatedTxFee;
  ckbRawTx.outputs[ckbRawTx.outputs.length - 1].capacity = append0x(changeCapacity.toString(16));
  const virtualTx = {
...
// src/spore/spore.ts
var import_core3 = require("@spore-sdk/core");
var import_signWitnesses4 = __toESM(require("@nervosnetwork/ckb-sdk-core/lib/signWitnesses"));
var import_ckb_sdk_utils13 = require("@nervosnetwork/ckb-sdk-utils");
var genCreateSporeCkbVirtualTx = async ({
  ...
  const sporeOutputsData = sporeDataList.map((data) => (0, import_ckb_sdk_utils13.bytesToHex)((0, import_core3.packRawSporeData)(data)));
  const outputs = [
    {
      ...clusterCell.output,
      // The BTC transaction Vouts[0] for OP_RETURN, Vouts[1] for cluster
...
var buildAppendingIssuerCellToSporesCreateTx = async ({
  ...
  const rawTx = ckbRawTx;
  const sumOutputsCapacity = rawTx.outputs.map((output) => BigInt(output.capacity)).reduce((prev, current) => prev + current, BigInt(0));
  const issuerLock = (0, import_ckb_sdk_utils13.addressToScript)(issuerAddress);
  let emptyCells = await collector.getCells({ lock: issuerLock });
  if (!emptyCells || emptyCells.length === 0) {
    throw new NoLiveCellError("The issuer address has no empty cells");
  }
  ...
  rawTx.outputs = [...rawTx.outputs, changeOutput];
  rawTx.outputsData = [...rawTx.outputsData, "0x"];
  const txSize = (0, import_ckb_sdk_utils13.getTransactionSize)(rawTx) + witnessLockPlaceholderSize + CELL_DEP_SIZE;
  const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
  changeCapacity -= estimatedTxFee;
  rawTx.outputs[rawTx.outputs.length - 1].capacity = append0x(changeCapacity.toString(16));
  return rawTx;
...
var appendIssuerCellToSporesCreate = async ({
  ...
  const issuerLock = (0, import_ckb_sdk_utils13.addressToScript)(issuerAddress);
  const keyMap = /* @__PURE__ */ new Map();
  keyMap.set((0, import_ckb_sdk_utils13.scriptToHash)(issuerLock), secp256k1PrivateKey);
  const issuerCellIndex = rgbppInputsLength;
  const cells = rawTx.inputs.map((input, index) => ({
    outPoint: input.previousOutput,
    lock: index >= issuerCellIndex ? issuerLock : getRgbppLockScript(isMainnet)
  ...
  const transactionHash = (0, import_ckb_sdk_utils13.rawTransactionToHash)(rawTx);
  const signedWitnesses = (0, import_signWitnesses4.default)(keyMap)({
    transactionHash,
    witnesses: rawTx.witnesses,
    inputCells: cells,
    skipMissingKeys: true
  ...
  const signedTx = {
    ...rawTx,
    witnesses: signedWitnesses.map(
      (witness) => typeof witness !== "string" ? (0, import_ckb_sdk_utils13.serializeWitnessArgs)(witness) : witness
    )
  };
  return signedTx;
};
var genTransferSporeCkbVirtualTx = async ({
  ...
  const txSize = (0, import_ckb_sdk_utils13.getTransactionSize)(ckbRawTx) + (witnessLockPlaceholderSize ?? RGBPP_TX_WITNESS_MAX_SIZE);
  const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
  changeCapacity -= estimatedTxFee;
  ckbRawTx.outputs[ckbRawTx.outputs.length - 1].capacity = append0x(changeCapacity.toString(16));
  const virtualTx = {
...
// src/spore/leap.ts
var import_base6 = require("@ckb-lumos/base");
var import_ckb_sdk_utils14 = require("@nervosnetwork/ckb-sdk-utils");
var genLeapSporeFromBtcToCkbVirtualTx = async ({
  ...
  const toLock = (0, import_ckb_sdk_utils14.addressToScript)(toCkbAddress);
  const outputs = [
    {
      ...sporeCell.output,
  ...
  let changeCapacity = BigInt(sporeCell.output.capacity);
  const txSize = (0, import_ckb_sdk_utils14.getTransactionSize)(ckbRawTx) + (witnessLockPlaceholderSize ?? RGBPP_TX_WITNESS_MAX_SIZE);
  const estimatedTxFee = calculateTransactionFee(txSize, ckbFeeRate);
  changeCapacity -= estimatedTxFee;
  ckbRawTx.outputs[ckbRawTx.outputs.length - 1].capacity = append0x(changeCapacity.toString(16));
  const virtualTx = {
...
var buildSporeBtcTimeCellsSpentTx = async ({
  ...
  for await (const btcTimeCell of sortedBtcTimeCells) {
    ...
    const result = await btcAssetsApi.getRgbppSpvProof(btcTxId, after);
    const { spvClient, proof } = transformSpvProof(result);
    if (!cellDepsSet.has((0, import_ckb_sdk_utils14.serializeOutPoint)(spvClient))) {
      cellDeps.push(buildSpvClientCellDep(spvClient));
      cellDepsSet.add((0, import_ckb_sdk_utils14.serializeOutPoint)(spvClient));
    }
    const btcTimeWitness = append0x(
      (0, import_ckb_sdk_utils14.serializeWitnessArgs)({ lock: buildBtcTimeUnlockWitness(proof), inputType: "", outputType: "" })
    );
    witnesses.push(btcTimeWitness);
  }
...
var genLeapSporeFromCkbToBtcRawTx = async ({
  ...
  const fromLock = (0, import_ckb_sdk_utils14.addressToScript)(fromCkbAddress);
  const sporeType = import_base6.blockchain.Script.unpack(sporeTypeBytes);
