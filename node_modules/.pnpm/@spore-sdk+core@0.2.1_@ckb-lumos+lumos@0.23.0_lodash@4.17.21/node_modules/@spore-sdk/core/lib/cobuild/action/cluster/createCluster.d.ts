...
export declare function assembleCreateClusterAction(clusterOutput: Cell | undefined): {
    actions: UnpackResult<typeof Action>[];
    scriptInfos: UnpackResult<typeof ScriptInfo>[];
};
export declare function generateCreateClusterAction(props: {
...
export declare function generateCreateClusterBuildingPacket(props: {
    txSkeleton: helpers.TransactionSkeletonType;
    outputIndex: number;
}): {
