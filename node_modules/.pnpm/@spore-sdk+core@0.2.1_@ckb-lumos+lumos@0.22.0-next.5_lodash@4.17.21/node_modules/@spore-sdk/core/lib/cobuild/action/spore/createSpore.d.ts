...
export declare function assembleCreateSporeAction(sporeOutput: Cell | undefined): {
    actions: UnpackResult<typeof Action>[];
    scriptInfos: UnpackResult<typeof ScriptInfo>[];
};
export declare function generateCreateSporeAction(props: {
...
export declare function generateCreateSporeBuildingPacket(props: {
    txSkeleton: helpers.TransactionSkeletonType;
    outputIndex: number;
    reference: Awaited<ReturnType<typeof injectNewSporeOutput>>['reference'];
}): {
