...
export declare function assembleTransferSporeAction(sporeInput: Cell | undefined, sporeOutput: Cell | undefined): {
    actions: UnpackResult<typeof Action>[];
    scriptInfos: UnpackResult<typeof ScriptInfo>[];
};
export declare function generateTransferSporeAction(props: {
...
export declare function generateTransferSporeBuildingPacket(props: {
    txSkeleton: helpers.TransactionSkeletonType;
    inputIndex: number;
    outputIndex: number;
