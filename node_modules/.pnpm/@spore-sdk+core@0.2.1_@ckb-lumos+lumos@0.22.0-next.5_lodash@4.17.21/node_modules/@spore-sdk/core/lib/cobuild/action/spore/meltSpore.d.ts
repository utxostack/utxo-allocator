...
export declare function assembleMeltSporeAction(sporeInput: Cell | undefined): {
    actions: UnpackResult<typeof Action>[];
    scriptInfos: UnpackResult<typeof ScriptInfo>[];
};
export declare function generateMeltSporeAction(props: {
...
export declare function generateMeltSporeBuildingPacket(props: {
    txSkeleton: helpers.TransactionSkeletonType;
    inputIndex: number;
}): {
