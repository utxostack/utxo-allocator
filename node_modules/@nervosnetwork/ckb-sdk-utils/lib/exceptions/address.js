...
exports.AddressFormatTypeAndEncodeMethodNotMatchException = exports.AddressFormatTypeException = exports.HashTypeException = exports.CodeHashException = exports.AddressException = exports.AddressPayloadException = void 0;
...
class AddressPayloadException extends Error {
    constructor(payload, type) {
        ...
        this.code = ErrorCode_js_1.default.AddressInvalid;
        this.type = type;
    }
}
...
class AddressFormatTypeException extends Error {
    constructor(type) {
...
class AddressFormatTypeAndEncodeMethodNotMatchException extends Error {
