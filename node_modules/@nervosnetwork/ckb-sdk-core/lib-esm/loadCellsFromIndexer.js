...
export const loadCellsFromIndexer = ({ CellCollector, indexer, lock, start, end, }) => __awaiter(void 0, void 0, void 0, function* () {
    var e_1, _a;
    ...
    const cells = [];
    try {
        for (var _b = __asyncValues(collector.collect()), _c; _c = yield _b.next(), !_c.done;) {
